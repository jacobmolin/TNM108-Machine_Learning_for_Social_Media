...
moviedir = r'/Users/jacobmolin/Dropbox/LiU/Åk4/HT1/TNM108/Labs/lab4/movie_reviews'
...
# print('movie.data[0]', movie.data[0])

# print('movie.filenames[0]', movie.filenames[0])

# target: [0,1], 0 = neg, 1 = pos
# print('movie.target[0]', movie.target[0])
...
grid_search_clf = GridSearchCV(clf_pipe, params, cv=5, iid=False, n_jobs=-1)
...
print('\ngrid_search_clf.best_score_:', grid_search_clf.best_score_, '\n')
